...
//                console.log("waypoints to use:", waypoints)
                ...
                // todo - change back to response.waypoints?
                this._saveHintData(waypoints, inputWaypoints);
            ...
            _convertRoute: function(responseRoute) {
                ...
                for (i = 0; i < legCount; i++) {
                    ...
                    for (j = 0; j < leg.steps.length; j++) {
                        step = leg.steps[j];
                        // console.log("decoding polyline:", step.geometry)
                        geometry = this._decodePolyline(step.geometry);
                        // console.log("result coords:", result.coordinates)
                        // console.log("geometry:", geometry)
                        // console.log("Pushing coordinate")
